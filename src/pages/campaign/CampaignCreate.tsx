...
type CampaignCreate = any;
const initialCampaignCreate = {};
...
dayjs.extend(utc);
const CampaignCreate = (props : any) =>{
   const {dispatch, loading, disabled = false, disableOnPrivate = false, ...campaign } = props;
    return (
